...
public abstract class Graph {
    ...
    public List<Integer> degreeSequence() {
        ...
        for (int i = 0; i < numVertices; i++) {
            ...
            List<Integer> a = getNeighbors(i);
            List<Integer> b = getInNeighbors(i);
    ...
    public static void main(String[] args) {
        GraphLoader.createIntersectionsFile("data/maps/UA.map", "data/intersections/UA.intersections");

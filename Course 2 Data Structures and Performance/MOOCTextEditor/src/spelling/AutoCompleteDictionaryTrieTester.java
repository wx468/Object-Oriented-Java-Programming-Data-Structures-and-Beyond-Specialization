...
public class AutoCompleteDictionaryTrieTester {
    ...
    public void testPredictCompletions() {
        ...
        assertTrue(allIn);
        System.out.println("---------HE-2--------");
        completions = smallDict.predictCompletions("HE", 2);// return [he, hey]
        //todo: but why when i type "PARADO", it shows "PARADOx"?
        allIn = completions.contains("he") &&
                (completions.contains("hem") || completions.contains("hey"));
        assertEquals(2, completions.size());
        assertTrue(allIn);
        System.out.println("---------hel--10-------");

...
public abstract class EarthquakeMarker extends CommonMarker {
    ...
    public EarthquakeMarker(PointFeature feature) {
        ...
        setProperties(properties);// method of supper class: Marker
        this.radius = 1.75f * getMagnitude();
        /**
         * WEI XU: if mag = 5, radius = 7.5;
         * todo: which is the correct radius? 2*mag or 1.75f*mag ???
         * */
    }
    ...
    public void showTitle(PGraphics pg, float x, float y) {
        ...
        pg.rect(x, y, 100, 50);
        pg.fill(10);
        pg.text(this.getTitle(), x + 2, y + 2, 100, 50);
